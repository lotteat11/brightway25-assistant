...
ecoinvent 3.11 uses a 4-tuple — `('ecoinvent-3.11', 'IPCC 2021', 'climate change: fossil',
'global warming potential (GWP100)')` — not the plausible-looking 3-tuple
`('IPCC 2021', 'climate change', 'GWP 100a')`. In example code write `method_key = ...`
with the lookup above it; a filled-in placeholder will get pasted.
